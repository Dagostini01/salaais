...
export const ResultModalScroll = styled.ScrollView.attrs({
...
export const ResultBlocksContainer = styled.View`
  flex-direction: row;
  justify-content: center;
  flex-wrap: wrap;
  margin-bottom: ${RFValue(16)}px;
...
export const ResultBlockButton = styled.TouchableOpacity<{
  backgroundColor: string;
  isSelected: boolean;
}>`
  background-color: ${({ backgroundColor }) => backgroundColor};
  padding-vertical: ${RFValue(10)}px;
  padding-horizontal: ${RFValue(14)}px;
...
export const ResultBlockText = styled.Text`
  color: white;
  font-weight: 700;
...
export const BlockButton = styled.TouchableOpacity<{ isSelected: boolean }>`
  padding-vertical: ${RFValue(8)}px;
  padding-horizontal: ${RFValue(4)}px;
  background-color: ${({ theme, isSelected }) =>
    isSelected ? theme.colors.primary : "gray"};
  border-radius: ${RFValue(10)}px;
  flex: 1;
  align-items: center;
  justify-content: center;
...
export const BlockButtonText = styled.Text`
  color: white;
